...
const CommonContactProject = ({ dataResult }) => {
  return (
    <>
                ...
                <Stack direction="row" sx={{ width: "200px" }}>
                  <Avatar sx={{ bgcolor: "#6B62E2" }}>
                    ...
                    dataResult.company !== undefined
                      ? dataResult.name.charAt(0).toUpperCase()
                      : "?"}
                  </Avatar>
                  <Box sx={{ width: "100%" }}>
                    <Typography
                      ...
                      style={{ fontSize: "14px" }}
                    >
                      {dataResult !== undefined && dataResult.name !== undefined
                        ? dataResult.name
                        : "Not Available"}
                    </Typography>
                    <Typography
...
export default CommonContactProject;
